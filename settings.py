...
NUM_OF_BINS = 10								# number of bins used in discretization
MINIMUM_DESCRIPTION_LENGTH_VALIDATION = False	# Use of optional secondary validation for discrete bins
STATIC_GAIN_CUTOFF = [ True, .0001 ]
